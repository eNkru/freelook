...
function setupListeners() {
    ...
    document.getElementById("windowReset").addEventListener("click", async () => {
        const button = document.getElementById("windowReset");
    ...
    document.getElementById("saveRestart").addEventListener("click", async () => {
        const button = document.getElementById("saveRestart");
...
function bindChange(elementId, configKey, afterSave) {
...
function syncZoomPreview(value) {
...
function setStatus(title, message, tone, autoReset = true) {
